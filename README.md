# nvim-treesitter-queries-objdump

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-objdump/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-objdump/actions/workflows/validate.yml)

Neovim tree-sitter queries for **objdump**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-objdump",
...
- [ ] Changes are scoped to `objdump` — do not include files for other languages
